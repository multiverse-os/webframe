...
func (self Tag) Attributes(attrs ...attribute.Attribute) Element {
	var attributes = map[attribute.Key][]string{}
...
func (self Tag) Close() string {
	return text.AngleBracketType.Enclose(entity.ForwardSlash.String() + self.String()).String()
}
