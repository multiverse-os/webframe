...
// TODO: This provide the formatter logic for extending colors on-top of fmt by
// adding new %X type logic. we can then add %{blue}%{bold} or like css
// %{color:blue;ansi:bold;}
// https://github.com/nhooyr/color
// This is important because its also the foundation for a nice implementation of
// locales without relying on outside dependencies
...
// doing ANSI better, but also provide simple way to handle localization.
...
// WE can just not place the ANSI in. Since file-logging is more likely use-case
...
// Writing To Outputs /////////////////////////////////////////////////////////
// TODO: Improve this by implementing Fprintf locally, so we can provide similar
// functionality to Output and Write.
...
// TODO: [[!!]] Functions for ANSI access so we don't need to include it elsewhere and
// alter implement it locally here so we have no deps

// TODO: Would be much better to just allow providing a closure, or a
// surrounding function, whatever that function does. And in our case it will be
