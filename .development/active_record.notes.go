...
// foundation on the database and model end of the starshipyard system and will
...
// TODO: THIS IS A PRETTY GOOD DIEA BUT TOTALLY OUT OF THE FUCKING SCOPE OF THIS
// CLI FRAMEWORK. This is more of an active record replacement. but thats needed
// for starship yard so im gonna copy the code into that project and continue
// forth.
